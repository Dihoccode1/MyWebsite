...
<body>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="cartModalLabel">
                        <i class="fa fa-check-circle text-success" aria-hidden="true"></i> Bạn đã thêm <span
                            id="productNameInModal">Sản phẩm</span> vào giỏ hàng
                    </h5>
                ...
                <div class="modal-body">
                    <div class="cart-preview">
                        <p class="h6">
                            <i class="fa fa-shopping-basket" aria-hidden="true"></i> Giỏ hàng của bạn (<span
                                id="cartCount">1</span> sản phẩm) &gt;
                        </p>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody id="cartItemsContainer">
                                <button class="btn-cart" data-toggle="modal" data-target="#cartModal"
                                    data-name="Sáp Vuốt Tóc Suavecito Oil Based" data-price="269000" data-sku="SUCPO"
                                    data-image="./assets/images/product/Hair_wax/Suavecito_Firme_Clay_Pomade/suavecito-firme-clay-open-2048x.webp">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4">
                            <div class="text-muted">Giao hàng trên toàn quốc</div>
                            <div>Tổng tiền: <span id="modalCartTotal" class="h5 text-danger font-weight-bold">0₫</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer d-flex justify-content-between">
                    <a href="#" data-dismiss="modal">Tiếp tục mua hàng</a>
                    <a href="#" class="btn btn-dark">Tiến hành đặt hàng</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <! <?php include __DIR__ . '/partials/header.php'; ?> <!--==================PAGE MAIN (mọi style chỉ áp dụng trong
        khối này)==================-->
        <div class="page-main">
                    ...
                    <div class="adv_bottom">
                        <div class="container">
                            <div class="adv-row">
                                ...
                                <div class="adv_bottom_inner">
                                    <figure><a href="#" title="Banner 3"><img src="assets/images/sap2.webp"
                                                alt="Banner 3" loading="lazy"></a></figure>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col col-3">
                                <div class="product-box">
                                    ...
                                    <div class="product-action-grid">
                                        <button class="btn-cart" data-toggle="modal" data-target="#cartModal"
                                            data-name="Sáp Vuốt Tóc Suavecito Oil Based" data-price="269000"
                                            data-sku="SUCPO"
                                            data-image="./assets/images/product/Hair_wax/Suavecito_Firme_Clay_Pomade/suavecito-firme-clay-open-2048x.webp">
                                            <i class="fa fa-plus" aria-hidden="true"></i> Giỏ hàng
                                        </button>
                            ...
                            <div class="col col-3">
                                <div class="product-box">
                                    ...
                                    <div class="product-info a-left">
                                        <h3 class="product-name"><a href="#">Bột Tạo Phồng Tóc Dapper Dan Texture
                                                Dust</a>
                                        </h3>
                                        <div class="price-box">
                            ...
                            <div class="col col-3">
                                <div class="product-box">
                                    ...
                                    <div class="product-info a-left">
                                        <h3 class="product-name"><a href="#">Bột tạo phồng Reuzel Matte Texture
                                                Powder</a>
                                        </h3>
                                        <div class="price-box">
                            ...
                            <div class="col col-3">
                                <div class="product-box">
                                    ...
                                    <div class="product-info a-left">
                                        <h3 class="product-name"><a href="#">Sáp vuốt tóc Kevin Murphy Rough Rider</a>
                                        </h3>
                                        <div class="price-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col col-3">
                                <div class="product-box">
                                    ...
                                    <div class="product-info a-left">
                                        <h3 class="product-name"><a href="#">Tinh dầu dưỡng tóc Blumaan Hydrating</a>
                                        </h3>
                                        <div class="price-box">
                            ...
                            <div class="col col-3">
                                <div class="product-box">
                                    ...
                                    <div class="product-info a-left">
                                        <h3 class="product-name"><a href="#">Gôm Xịt Cứng Davines Strong Hairspray</a>
                                        </h3>
                                        <div class="price-box">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col col-6 content_banner">
                            ...
                            <div class="des">
                                ...
                                <p>Sáp vuốt tóc được làm thủ công bởi những người thợ lành nghề — hương thơm đặc trưng,
                                    độ
                                    giữ nếp cao.</p>
                        ...
                        <div class="col col-6 content_banner">
                            ...
                            <div class="des">
                                ...
                                <p>Những dòng sáp mới nhất được cập nhật từ các thương hiệu nổi tiếng như By Vilain,
                                    Hanz de
                                    Fuko, Apestomen…</p>
                                <a href="#" class="hidden-xs" title="Xem thêm">Xem thêm</a>
                            </div>
                    ...
                    <div class="about-home">
                        <div class="inner">
                            <h2>Về chúng tôi</h2>
                            <p>
                                Nobility 1800s mang đến cho khách hàng trải nghiệm mua sắm thời trang hàng hiệu trực
                                tuyến
                                đẳng cấp, quy tụ những thương hiệu thời trang quốc tế và trong nước.
                                Chúng tôi cam kết mang lại chất lượng phục vụ tốt nhất, cùng bộ sưu tập khổng lồ gồm
                                quần
                                áo, giày dép, phụ kiện và mỹ phẩm cho cả nam và nữ — bắt kịp xu hướng thời trang mới
                                nhất
                                trên thế giới.

                                Tại Nobility 1800s, bạn dễ dàng tìm thấy mọi phong cách mình muốn:
                                từ những trang phục thoải mái ở nhà, đồ công sở lịch lãm, cho đến set đồ dạo phố năng
                                động.
        ...
        (function() {
            ...
            const removeItem = (sku) => {
                ...
                // Nếu giỏ hàng trống, ẩn modal sau khi xóa (tùy chọn)
                if (cart.length === 0) {
            ...
            const addToCart = (product) => {
                ...
                saveCart(cart);
                renderCartModal();
                $('#cartModal').modal('show'); // Hiển thị modal sau khi thêm
            };
            ...
            const renderCartModal = () => {
                ...
                cart.forEach(item => {
                    ...
                    row.innerHTML = `
                <td>
                    <img src="${item.image}" alt="${item.name}" width="50" height="50" style="margin-right: 10px; border-radius: 4px; display: inline-block; vertical-align: middle;">
                    <span style="display: block; font-weight: 500;">${item.name}</span>
                    <div class="text-danger small" style="margin-top: 5px;">
                        <a href="#" class="remove-item-link" data-sku="${item.sku}">× Bỏ sản phẩm</a>
                    </div>
                </td>
                <td class="text-center">${formatCurrency(item.price)}</td>
                <td>
                    <div class="input-group input-group-sm quantity-control" style="max-width: 100px; margin: 0 auto;">
                        <div class="input-group-prepend"><button class="btn btn-outline-secondary btn-minus" data-sku="${item.sku}">-</button></div>
                        <input type="text" class="form-control text-center cart-qty-input" value="${item.quantity}" data-sku="${item.sku}">
                        <div class="input-group-append"><button class="btn btn-outline-secondary btn-plus" data-sku="${item.sku}">+</button></div>
                    </div>
                </td>
                <td class="text-right font-weight-bold">${formatCurrency(itemTotal)}</td>
            `;
                ...
                modalCartTotalElement.textContent = formatCurrency(totalCartAmount);

                // Thêm sự kiện cho các nút điều khiển mới
                container.querySelectorAll('.btn-minus').forEach(btn => {
                    btn.onclick = (e) => {
                        e.preventDefault();
                        const sku = btn.getAttribute('data-sku');
                        const input = container.querySelector(`.cart-qty-input[data-sku="${sku}"]`);
                        updateQuantity(sku, parseInt(input.value) - 1);
                    };
                });
                ...
                container.querySelectorAll('.cart-qty-input').forEach(input => {
                    input.onchange = (e) => {
                        ...
                        updateQuantity(sku, input.value);
                    };
                });

                container.querySelectorAll('.remove-item-link').forEach(link => {
                    link.onclick = (e) => {
                        e.preventDefault();
                        removeItem(link.getAttribute('data-sku'));
                    };
                });

                // Cập nhật thông báo modal header (sau khi thêm SP, chỉ hiện tên SP vừa thêm)
                const lastAddedProduct = cart.length > 0 ? cart[cart.length - 1].name : 'Sản phẩm';
                document.getElementById('productNameInModal').textContent = lastAddedProduct;
            };

            // --- EVENT LISTENERS ---

            // 1. Lắng nghe sự kiện click vào nút "Giỏ hàng" (Thêm sản phẩm)
            document.querySelectorAll('.btn-cart').forEach(button => {
                button.addEventListener('click', (event) => {
                    // Ngăn chặn hành vi mặc định của modal (vì ta sẽ tự gọi sau khi thêm)
            ...
            // 2. Lắng nghe sự kiện Modal sắp mở (để đảm bảo giỏ hàng được cập nhật)
            $('#cartModal').on('show.bs.modal', function() {
                renderCartModal();
            });

            // Cập nhật giỏ hàng khi trang tải (nếu cần hiển thị số lượng giỏ hàng trên header)
            // renderCartModal(); 
        })();
        </script>
</body>
