...
<head>
  ...
  <link rel="stylesheet" href="../News Section/style.css"><!-- sidebar dùng css này -->
...
<body>
  ...
  <section class="bread-crumb">
    <div class="container">
      <ul class="breadcrumb">
        ...
        <li><strong><span>Sơmi denim cho chàng khoe cá tính</span></strong></li>
      </ul>
    </div>
  </section>
  ...
  <div class="container mt-5 px-3 px-md-4 px-lg-5">
    <div class="row">
      ...
      <!-- Bài viết 70% (GIỮ NGUYÊN LINK NỘI DUNG CỦA BẠN) -->
