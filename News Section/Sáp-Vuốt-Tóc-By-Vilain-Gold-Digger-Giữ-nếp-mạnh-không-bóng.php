...
<head>
  ...
  <link rel="stylesheet" href="../News Section/style.css">
  <style>
    :root{
...
/* Link mặc định trong breadcrumb */
...
/* Mục cuối (bài hiện tại) là text thường, không link */
    ...
    <div class="row">
      <div class="col-xs-12">
        <ul class="breadcrumb">
          ...
          <!-- Cấp 3: Bài hiện tại -->
          <li>
            <strong><span>Sáp Vuốt Tóc By Vilain Gold Digger – Giữ nếp mạnh, không bóng</span></strong>
          </li>
        </ul>
      </div>
    </div>
