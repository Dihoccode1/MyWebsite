...
<body>
    ...
    <div class="container" itemscope itemtype="http://schema.org/Blog">
        ...
        <div class="row">
            ...
            <!-- MAIN -->
            <section class="right-content margin-bottom-50 col col-md-9 col-md-push-3">
                        ...
                        <div class="col col-xs-12 blog_xxx">
                            <article class="blog-item">
                                ...
                                <div class="blog-item-info">
                                    ...
                                    <div class="date">
                                        <div class="post-time">Đăng ngày&nbsp;29/09/2025</div> <!-- THAY NGÀY -->
                                        <div class="news_home_content_short_time">bởi <span>THE MAN</span></div> <!-- THAY TÊN SHOP -->
                                    </div>
