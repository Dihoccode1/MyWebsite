...
<body>
    ...
    <div class="container">
        <nav class="breadcrumbs">
            <a href="#">Trang chủ</a> / <a href="sanpham.php">Tất cả sản phẩm</a> / <span>Tinh Chất Chống Rụng Tóc,
                Dưỡng Tóc Davines Energizing Superactive</span>
        </nav>
        <hr />
    </div>
    ...
    <div class="container product-detail-page">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="main-image">
                    <img id="mainProductImage"
                        src="../../assets/images/product/Hair_conditioner/Davines_Energizing_Superactive/superactive.webp"
                        alt="Tinh Chất Chống Rụng Tóc, Dưỡng Tóc Davines Energizing Superactive" />
                </div>
            </div>

            <div class="col-lg-7 col-md-6 product-info">
                <h1>Tinh Chất Chống Rụng Tóc, Dưỡng Tóc Davines Energizing Superactive</h1>
                <p class="text-muted">Thương hiệu: Davines</p>
        ...
        <div class="row">
            <div class="col-12 product-description">
                <h2>TINH CHẤT CHỐNG RỤNG TÓC, DƯỠNG TÓC DAVINES ENERGIZING SUPERACTIVE</h2>

                <ul>
                    <li>Sản phẩm có chứa hoa Cohosh đen – một loại cây mọc quanh năm ở vùng Bắc Mỹ, có tác dụng
                        ngăn chặn enzim 5-reduttasiihydrotestosterone.</li>
                    <li>Khi ngăn chặn được loại Enzim này sẽ giúp giải quyết vấn đề rụng tóc do di truyền, hoặc do lượng
                        dầu dư thừa trên tóc và da đầu nguyên nhân chính dẫn đến hiện tượng rụng tóc.</li>
                    <li>Sản phẩm tinh chất dưỡng tóc Davines Energizing Superactive không hề chứa các thành phần từ
                        paraben, tuyệt đối không gây kích ứng hay khô tóc và da đầu, đặc biệt an toàn cho người sử
                        dụng.</li>
                </ul>
                ...
                <ol>
                    <li>Sau khi gội đầu xong.</li>
                    <li>Lấy một lượng tinh chất vừa đủ thoa đều lên da đầu.</li>
